---
name: db-change
description: Change the data model, MongoDB indexes, or Elasticsearch mappings, and add the spec-driven integration test in the same change, per backend_protocol.md.
---
