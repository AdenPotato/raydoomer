---
name: new-screen
description: Scaffold a UI screen or component with a failing render test first, theme tokens, and the project's smoke check, per frontend_protocol.md.
---

Use to add a UI screen or component. Canonical rules: [frontend_protocol.md](../../../docs/protocol/frontend_protocol.md); tokens + taxonomy: [style_guide.md](../../../docs/design/style_guide.md). For data, see [integration_protocol.md](../../../docs/protocol/integration_protocol.md).
...
4. If the screen needs new service data, run `/new-contract` first.
