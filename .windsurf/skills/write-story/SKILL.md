---
name: write-story
description: Use to draft or refine a Linear issue to the team's story template - title, statement, context, acceptance criteria, scope, Definition of Done.
---

Author or tighten a Linear issue (new or existing) **without** creating/updating the issue itself - that is the `new-work-item` skill. Canonical template: [authoring.md](../../../docs/reference/authoring.md#linear-issue-template).
...
4. Hand the result to the `new-work-item` skill to create the Linear issue, or paste it into the existing one.
